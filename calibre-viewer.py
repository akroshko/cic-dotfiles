...
# This file is copied to "$HOME/.config/calibre/viewer.py" in order to customize some aspects of ebook-viewer.
# It is based on a file saved from ebook-viewer and it is modified on an as-needed basis when issues arise.
