...
main () {
    ...
    need_new_symlink ${SCRIPTPATH}/../bash-stdlib/youtube-pause-minimize.sh   ${HOME}/bin/youtube-pause-minimize.sh
    need_new_symlink ${SCRIPTPATH}/../bash-stdlib/youtube-pause-toggle.sh     ${HOME}/bin/youtube-pause-toggle.sh
